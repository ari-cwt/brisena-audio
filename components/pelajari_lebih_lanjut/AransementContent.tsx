export default function AransemenContent() {
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3 text-center">
        ...
        <p className="text-xl md:text-2xl font-medium">Rp. 3.000.000</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ol className="space-y-5 list-decimal list-inside text-white/80 text-sm md:text-base leading-relaxed">
          ...
          <li>
            <span className="font-medium text-white">Proses Aransemen</span>
            <p className="mt-1">
              • Proses pengerjaan dilakukan sesuai brief yang telah disepakati.
              <br />• Estimasi waktu pengerjaan 5–10 hari kerja.
            </p>
          </li>
          ...
          <li>
            ...
            <p className="mt-1">
              • Tersedia 2 (dua) kali revisi minor (±2 hari kerja per revisi).
          ...
          <li>
            ...
            <p className="mt-1">
              • File master final dikirim melalui Google Drive atau Dropbox.
            </p>
          </li>
        </ol>
      </div>
