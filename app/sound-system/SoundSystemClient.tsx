          ...
          {packages.map((pkg) => (
            <div
              ...
              className={`
                ...
                hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(236,72,153,0.15)]
                bg-white/5 backdrop-blur-xl border 
                ${
                  pkg.popular
                    ? "border-pink-500/50 shadow-[0_0_20px_rgba(236,72,153,0.1)]"
                    : "border-white/10"
                }
              `}
            >
              ...
              <div className="flex flex-col flex-1 p-8">
                ...
                <a
                  href={`https://wa.me/628XXXXXXXXXX?text=Halo,%20saya%20ingin%20bertanya%20tentang%20sewa%20Sound%20System%20paket%20${pkg.watt}`}
                  target="_blank"
